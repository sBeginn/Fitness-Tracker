...
def analyze_hands(frame, hand_distance_threshold_pixels):
    ...
    percentage = 0  # Initialize percentage with a default value
...
def main(video_path, shoulder_threshold_meters=0.2, fingertips_threshold_pixels=50):
    ...
    if average_shoulder_score >= 95:
        ...
        shoulder_feedback = "Shoulders: Very bad! Please watch the instruction video"
    ...
    if average_hand_score >= 95:
        ...
        hand_feedback = "Hands: Very bad! Please watch the instruction video"
